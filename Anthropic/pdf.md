# PDF 处理 (/mnt/skills/public/pdf/SKILL.md)

---
* name: PDF 处理
* description: 全面的 PDF 操作工具包，支持提取文本和表格、创建新 PDF、合并/拆分文档以及处理表单。
* when_to_use: 当 Claude 需要填写 PDF 表单，或大规模以编程方式处理、生成或分析 PDF 文档时使用。
* version: 0.0.1
...
本指南介绍了使用 Python 库和命令行工具进行基本 PDF 处理的操作。有关高级功能、JavaScript 库和详细示例，请参阅 REFERENCE.md。如果你需要填写 PDF 表单，请阅读 FORMS.md 并遵循其指示。
...
### 从扫描的 PDF 中提取文本
```python
# 要求: pip install pytesseract pdf2image
import pytesseract
...
- 如果你需要填写 PDF 表单，请遵循 FORMS.md 中的指示
